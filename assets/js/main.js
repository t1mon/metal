	...
	function handleSearch() {	
		...
		$('#custom-search-button').on("click", function(e) { 
			...
			if ($("#header").hasClass("stuck")) {
				$("body").toggleClass("custom-search-form-stuck");
				$("#custom-search-form").prependTo("#header").slideToggle(300);
			} else {
				$("#custom-search-form").insertBefore("#wrap").slideToggle(300);
			}			
		...
		$('#custom-search-form a.close').on("click", function(event){
			...
			$("body").removeClass("custom-search-form-stuck");			
   ...
   ========================================================================== */
	...
	$(document).ready(function() {			   
		...
		if(typeof $.fn.revolution !== 'undefined'){
			...
			$('.fullwidthbanner-header-style-1').revolution({
				delay:9000,
				startwidth:1170,
				startheight:590,
				startWithSlide:0,
			...
			$('.fullwidthbanner-header-style-2').revolution({
				delay:9000,
				startwidth:1170,
				startheight:790,
				startWithSlide:0,
